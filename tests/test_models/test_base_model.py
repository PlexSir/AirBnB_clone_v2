...
class Test_docstrings(unittest.TestCase):
    ...
    def setup_class(self):
        ...
        Return all members of object in list of (name, value)
        pairs sorted by name
        only members for which predicate returns true value are included
        """
        self.obj_members(BaseModel, inspect.isfunction)


class TestBaseModel(unittest.TestCase):
    """this will test base model class x"""
    ...
    @classmethod
    def teardown(cls):
        """at end of test this will tear it down"""
        del cls.base
    ...
    def test_init_BaseModel(self):
        """test if base is type BaseModel"""
