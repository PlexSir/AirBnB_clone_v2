...
class HBNBCommand(cmd.Cmd):
    ...
    def precmd(self, line):
        """Reformat command line advanced command syntax.
    ...
    def do_quit(self, command):
        """ Method to exit HBNB console"""
        exit()

    def help_quit(self):
        """ Prints help documentation for quit  """
        print("Exits program with formatting\n")
    ...
    def help_EOF(self):
        ...
        print("Exits program without formatting\n")
    ...
    def help_show(self):
        ...
        print("Shows individual instance of class")
    ...
    def help_destroy(self):
        ...
        print("Destroys individual instance of class")
    ...
    def help_all(self):
        ...
        print("Shows all objects, or all of class")
